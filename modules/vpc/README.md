...
| <a name="input_enable_shared_snat"></a> [enable\_shared\_snat](#input\_enable\_shared\_snat) | (Deprecated) Enable the shared SNAT capability on VPCs in eu-de region. (default: null) | `bool` | `null` | no |
